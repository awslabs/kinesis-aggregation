...
var builder = ProtoBuf.loadProtoFile(libPath + "/" + constants.protofile)
var AggregatedRecord = builder.build(constants.kplConfig[constants.useKplVersion].messageName);
