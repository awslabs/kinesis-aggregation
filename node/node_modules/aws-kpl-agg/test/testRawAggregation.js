...
var agg = require(libPath + '/kpl-agg');
require("../constants");
...
var builder = ProtoBuf.loadProtoFile(libPath + "/" + protofile), AggregatedRecord = builder
		.build(kplConfig[useKplVersion].messageName);
...
// capture the buffer
var d = Buffer.concat([ magic, protoData.toBuffer(), checksum ]).toString(
		'base64');

agg.aggregate(rawRecords, function(err, encoded) {
	encoded.should.equal(d);
});