...
module.exports.deaggregateSync = function(kinesisRecord, computeChecksums, afterRecordCallback) {
	"use strict";
	...
	exports.deaggregate(kinesisRecord, computeChecksums, function(err, userRecord) {
		if (err) {
...
module.exports.deaggregate = function(kinesisRecord, computeChecksums, perRecordCallback, afterRecordCallback) {
	"use strict";
	...
	if (recordBuffer.slice(0, 4).toString('hex') === kplConfig[useKplVersion].magicNumber) {
		try {
			// this is a valid KPL encoded message - see
