...
public class ProducerUtils {
	// Use this is you want to send the same records every time (useful for
	// testing)
	 ...
	 *            The sequence number of hte record in the overall stream of
	 *            records.
	 * @param desiredLength
	 ...
	 * 
	 * @param region
	 *            The region of the Kinesis stream to publish to.
	 * 
