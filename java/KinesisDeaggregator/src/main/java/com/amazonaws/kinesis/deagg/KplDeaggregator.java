...
/**
 * Kinesis Producer Library Deaggregator convenience class.  This class contains a number
 * of static methods that provide different interfaces for deaggregating user records from
 * an existing aggregated Kinesis record.
 * 
...
public class KplDeaggregator
{
     ...
     * KinesisUserRecords.
     * 
     * @param inputRecord The single KinesisEventRecord to deaggregate
     * @return A list of Kinesis UserRecord objects obtained by deaggregating
